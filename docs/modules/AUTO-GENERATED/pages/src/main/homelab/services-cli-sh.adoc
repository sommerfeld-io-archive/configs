...
include::ROOT:partial$homelab/docker-stacks/monitoring-fritz-box.adoc[]
...
include::ROOT:partial$homelab/docker-stacks/sommerfeld-io.adoc[]

=== Docker Compose Stack: websites

include::ROOT:partial$homelab/docker-stacks/websites.adoc[]
